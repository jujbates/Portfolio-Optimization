...
class PortfolioOptimization:
    ...
    def __init__(self, table):
        mu = pypfopt.expected_returns.mean_historical_return(table)
        S = pypfopt.risk_models.sample_cov(table)
        ...
        latest_prices = pypfopt.discrete_allocation.get_latest_prices(table)
        self.allocation, self.leftover = pypfopt.discrete_allocation.DiscreteAllocation(
